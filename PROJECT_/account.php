                ...
                <form id="account-form" method="POST" action="account.php" >
                  ...
                  <h3>Change password</h3>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="account-confirm-password" placeholder="Confirm Password" name="confirmpassword" required/>
                    </div>
                    <div class="form-group">
        ...
        <section id="orders" class="orders container my-5 py-3">
            ...
            <table class="mt-5 pt-5">
                <tr >
                    ...
                    <th>Order status</th>
                    <th>Order Date</th>
                    <th id="or-details" >Order details</th>
                </tr>
                      ...
                      <tr>
                          <td>
                              <!--<div class="product-info">
                                <img src="assets/imgs/shoes1.jpg">
